...
try {
    ...
    $params = @{
        ...
        siteId    = "{fbae8fe3-2f44-45d9-b950-7a5195d86dfe}"
        webId     = "{0d566c24-97a7-4123-9894-192913668d21}"
        listId    = "{443BA059-B94A-4912-AEBA-0D1D0A7F763A}"
        userEmail = $userUpn
        webUrl    = "https://krclogistics.sharepoint.com/sites/customer-service"
        webTitle  = "Customer Service"
        listTitle = "Documents"
    }
    $regKeyLocation="HKCU:\Software\Microsoft\Windows\CurrentVersion\Run"
    $ScriptName="SharepointSync-CServ"
