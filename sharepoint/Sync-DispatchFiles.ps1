...
try {
    ...
    $params = @{
        ...
        siteId    = "{ffab4dfe-d814-41db-9d73-f731b9922131}"
        webId     = "{0d566c24-97a7-4123-9894-192913668d21}"
        listId    = "{443BA059-B94A-4912-AEBA-0D1D0A7F763A}"
        userEmail = $userUpn
        webUrl    = "https://krclogistics.sharepoint.com/sites/dispatch-files"
        webTitle  = "Dispatch Files"
        listTitle = "Documents"
    }
    $regKeyLocation="HKCU:\Software\Microsoft\Windows\CurrentVersion\Run"
    $ScriptName="SharepointSync-DispatchFiles"
