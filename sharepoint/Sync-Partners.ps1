...
try {
    ...
    $params = @{
        ...
        siteId    = "{5ad5c6da-b03d-4e4e-b763-afd395bd34d3}"
        webId     = "{0d566c24-97a7-4123-9894-192913668d21}"
        listId    = "{443BA059-B94A-4912-AEBA-0D1D0A7F763A}"
        userEmail = $userUpn
        webUrl    = "https://krclogistics.sharepoint.com/sites/partner-carriers"
        webTitle  = "Partner Carriers"
        listTitle = "Documents"
    }
    $regKeyLocation="HKCU:\Software\Microsoft\Windows\CurrentVersion\Run"
    $ScriptName="SharepointSync-Partners"
